...
const CITY_DATABASE = (() => {
    ...
    // =============================================
    // TÜRKİYE - 81 İL (Tamamı)
    // =============================================
    const TURKEY = [
        { city: 'Adana', country: 'Türkiye', region: 'tr', lat: 37.00, lon: 35.32, climate: 'warm', size: 'mega', nature: 'urban', vibe: ['career', 'adventure'] },
        { city: 'Adıyaman', country: 'Türkiye', region: 'tr', lat: 37.76, lon: 38.28, climate: 'warm', size: 'small', nature: 'mountain', vibe: ['peace', 'growth'] },
        { city: 'Afyonkarahisar', country: 'Türkiye', region: 'tr', lat: 38.74, lon: 30.54, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Ağrı', country: 'Türkiye', region: 'tr', lat: 39.72, lon: 43.05, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['growth', 'adventure'] },
        { city: 'Aksaray', country: 'Türkiye', region: 'tr', lat: 38.37, lon: 34.03, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Ardahan', country: 'Türkiye', region: 'tr', lat: 41.11, lon: 42.70, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace', 'growth'] },
        ...
        { city: 'Batman', country: 'Türkiye', region: 'tr', lat: 37.89, lon: 41.13, climate: 'warm', size: 'small', nature: 'urban', vibe: ['growth'] },
        { city: 'Bayburt', country: 'Türkiye', region: 'tr', lat: 40.26, lon: 40.23, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Bilecik', country: 'Türkiye', region: 'tr', lat: 40.05, lon: 30.00, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Bingöl', country: 'Türkiye', region: 'tr', lat: 38.88, lon: 40.49, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace', 'growth'] },
        ...
        { city: 'Çanakkale', country: 'Türkiye', region: 'tr', lat: 40.16, lon: 26.41, climate: 'moderate', size: 'small', nature: 'coastal', vibe: ['peace', 'learning'] },
        { city: 'Çankırı', country: 'Türkiye', region: 'tr', lat: 40.60, lon: 33.62, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Çorum', country: 'Türkiye', region: 'tr', lat: 40.55, lon: 34.96, climate: 'moderate', size: 'small', nature: 'urban', vibe: ['peace'] },
        ...
        { city: 'Edirne', country: 'Türkiye', region: 'tr', lat: 41.68, lon: 26.56, climate: 'moderate', size: 'small', nature: 'urban', vibe: ['learning', 'creativity'] },
        { city: 'Elazığ', country: 'Türkiye', region: 'tr', lat: 38.67, lon: 39.22, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['learning'] },
        { city: 'Erzincan', country: 'Türkiye', region: 'tr', lat: 39.75, lon: 39.49, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Gümüşhane', country: 'Türkiye', region: 'tr', lat: 40.46, lon: 39.48, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Iğdır', country: 'Türkiye', region: 'tr', lat: 39.92, lon: 44.05, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Isparta', country: 'Türkiye', region: 'tr', lat: 37.76, lon: 30.55, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace', 'learning'] },
        ...
        { city: 'Kahramanmaraş', country: 'Türkiye', region: 'tr', lat: 37.58, lon: 36.94, climate: 'moderate', size: 'medium', nature: 'mountain', vibe: ['growth'] },
        { city: 'Karabük', country: 'Türkiye', region: 'tr', lat: 41.20, lon: 32.63, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Karaman', country: 'Türkiye', region: 'tr', lat: 37.18, lon: 33.23, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Kars', country: 'Türkiye', region: 'tr', lat: 40.60, lon: 43.10, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['adventure', 'peace'] },
        { city: 'Kastamonu', country: 'Türkiye', region: 'tr', lat: 41.39, lon: 33.78, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Kırıkkale', country: 'Türkiye', region: 'tr', lat: 39.85, lon: 33.51, climate: 'moderate', size: 'small', nature: 'urban', vibe: ['career'] },
        { city: 'Kırklareli', country: 'Türkiye', region: 'tr', lat: 41.74, lon: 27.23, climate: 'moderate', size: 'small', nature: 'urban', vibe: ['peace'] },
        { city: 'Kırşehir', country: 'Türkiye', region: 'tr', lat: 39.15, lon: 34.17, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Kütahya', country: 'Türkiye', region: 'tr', lat: 39.42, lon: 29.98, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['creativity', 'peace'] },
        ...
        { city: 'Mardin', country: 'Türkiye', region: 'tr', lat: 37.31, lon: 40.74, climate: 'warm', size: 'small', nature: 'mountain', vibe: ['creativity', 'growth', 'peace'] },
        ...
        { city: 'Muş', country: 'Türkiye', region: 'tr', lat: 38.75, lon: 41.51, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['peace', 'growth'] },
        { city: 'Nevşehir', country: 'Türkiye', region: 'tr', lat: 38.63, lon: 34.71, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['creativity', 'peace', 'growth'] },
        { city: 'Niğde', country: 'Türkiye', region: 'tr', lat: 37.97, lon: 34.68, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Ordu', country: 'Türkiye', region: 'tr', lat: 40.98, lon: 37.88, climate: 'moderate', size: 'small', nature: 'coastal', vibe: ['peace'] },
        { city: 'Osmaniye', country: 'Türkiye', region: 'tr', lat: 37.07, lon: 36.25, climate: 'warm', size: 'small', nature: 'urban', vibe: ['peace'] },
        ...
        { city: 'Sivas', country: 'Türkiye', region: 'tr', lat: 39.75, lon: 37.01, climate: 'cold', size: 'medium', nature: 'mountain', vibe: ['peace', 'growth'] },
        { city: 'Şırnak', country: 'Türkiye', region: 'tr', lat: 37.52, lon: 42.46, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['growth'] },
        { city: 'Tekirdağ', country: 'Türkiye', region: 'tr', lat: 40.98, lon: 27.51, climate: 'moderate', size: 'medium', nature: 'coastal', vibe: ['peace'] },
        { city: 'Tokat', country: 'Türkiye', region: 'tr', lat: 40.31, lon: 36.55, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Tunceli', country: 'Türkiye', region: 'tr', lat: 39.11, lon: 39.55, climate: 'cold', size: 'small', nature: 'mountain', vibe: ['adventure', 'growth', 'peace'] },
        { city: 'Uşak', country: 'Türkiye', region: 'tr', lat: 38.67, lon: 29.41, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        ...
        { city: 'Yozgat', country: 'Türkiye', region: 'tr', lat: 39.82, lon: 34.80, climate: 'moderate', size: 'small', nature: 'mountain', vibe: ['peace'] },
        { city: 'Zonguldak', country: 'Türkiye', region: 'tr', lat: 41.45, lon: 31.79, climate: 'moderate', size: 'small', nature: 'coastal', vibe: ['peace'] },
    ];
