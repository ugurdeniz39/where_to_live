...
## 2. Kullanici Sorumluluklar

Uygulamayi kullanirken asagidaki kurallara uymayai kabul edersiniz:

- Uygulamayi yalnizca yasal amaclarla kullanmak.
- Yanlis veya yaniltici bilgi saglamamak.
- Uygulamanin teknik altyapisina mudahale etmemek veya zarar vermemek.
- Diger kullanicilarin deneyimini olumsuz etkileyecek davranislarda bulunmamak.
- 13 yasindan buyuk olmak.
...
- Abonelikler, iptal edilmedigi surece otomatik olarak yenilenir.
- Iptal islemi bir sonraki fatura doneminin basinda gercerli olur; mevcut donem icin iade yapilmaz.

### 3.3 Iade Politikasi
- Yasal haklariniz sakli kalmak kaydiyla, dijital icerik teslimatindan sonra iade talepleri iyzico politikalarina tabidir.
- Teknik sorunlardan kaynaklanan erisim problemlerinde destek ekibimizle iletisime gecebilirsiniz.
...
- Yasal zorunluluklar gerektirdigi durumlarda.

Hesap sonlandirilmasi halinde, aktif abonelik donemi sonuna kadar hizmet devam eder.

---

## 8. Degisiklikler

Bu kullanim kosullarini zaman zaman guncelleyebiliriz. Onemli degisiklikler yapildiginda kullanicilarimizi uygulama icerisinden bilgilendiririz. Degisikliklerden sonra uygulamayi kullanmaya devam etmeniz, guncel kosullari kabul ettiginiz anlamina gelir.

---

## 9. Uygulanacak Hukuk

Bu kullanim kosullari Turkiye Cumhuriyeti yasalarina tabidir. Uyusmazlik durumunda Istanbul mahkemeleri ve icra daireleri yetkilidir.
...
*Bu kullanim kosullari Mart 2026 tarihinde yayinlanmistir.*
